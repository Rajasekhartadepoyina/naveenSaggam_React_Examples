  ...
  return (
    <div>
      ...
      <div>
        ...
        <h1>{message}</h1>
        <button className="btn btn-primary" onClick={() => gm("Good Morning")}>
          Good Morning
        </button>
        <button className="btn btn-danger" onClick={() => gm("Good Afternoon")}>
          Good Afternoon
        </button>
        <button class="btn btn-success" onClick={() => gm("Good Evening")}>
          Good Evening
        </button>
      </div>
      <div>
